		...
		<table class="u-full-width">
			...
			<?php foreach ($allusers as $row) { ?>
				<tr>
					...
					<td>
						<a id="<?php echo $row->userid ?>" onclick="javascript:deleteConfirm('<?php echo base_url() ?>index.php/admin/admin_delete_user?uid=<?php echo $row->userid ?>')"><i class="material-icons not-menu red md-24">delete_forever</i></a>
					</td>
				</tr>
				<?php } ?>
			</tbody>
